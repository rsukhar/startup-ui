...
<SToggleGroup>
    <SToggle title="В чем отличие от аналогов?">
        ...
        <ol>
            ...
            <li>Поддерживает опциональную интеграцию с InertiaJS (зарегистрированный <code>Link</code>) для бесшовного роутинга между страницами; без неё — обычные ссылки <code>&lt;a&gt;</code>.</li>
        </ol>
    </SToggle>
...
| labelLink | string | `undefined` | URL для клика по самому лейблу меню. Если передано, область лейбла работает как навигационная ссылка (зарегистрированный `Link` или обычный `<a>`). |
