...
const code2 = `<SCopyText layout="inline">Секретный код для копирования</SCopyText> в обычном тексте.
`;
...
const code3 = `<SCopyText copytext="777">Секретный код: 777</SCopyText>
`;
